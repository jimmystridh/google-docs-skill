...
```bash
scripts/docs_manager read 1abc-xyz-document-123
```
...
```bash
scripts/docs_manager structure 1abc-xyz-document-123
```
...
scripts/docs_manager structure new_doc_abc
...
scripts/docs_manager read proposal_doc_123 > current_state.json
...
create_from_template() {
  ...
  }' | scripts/docs_manager create | jq -r '.document_id')
...
scripts/drive_manager download \
  --file-id "$doc_id" \
...
scripts/docs_manager read doc_abc_123

# Step 2: Get structure for reference points
scripts/docs_manager structure doc_abc_123
...
scripts/docs_manager read doc_abc_123 > backup.json
...
scripts/docs_manager read doc_abc
# ... format operation ...
scripts/docs_manager read doc_abc
...
scripts/docs_manager read doc_abc > state.json
scripts/docs_manager structure doc_abc > structure.json
...
scripts/docs_manager structure doc_abc
